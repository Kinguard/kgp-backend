...
void MailConfig::SetAddress(const string &domain, const string &address, const string &user)
{
	this->config[domain][address]=user;
}

void MailConfig::DeleteAddress(const string &domain, const string &address)
{
...
list<tuple<string, string> > MailConfig::GetAddresses(const string &domain)
{
...
bool MailConfig::hasDomain(const string &domain)
{
	return this->config.find(domain) != this->config.end();
}

bool MailConfig::hasAddress(const string &domain, const string &address)
{
